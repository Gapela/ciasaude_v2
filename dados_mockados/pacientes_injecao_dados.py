...
def maker_query_lista(pacientes_lista):
    ...
    for paciente in pacientes_lista:
        ...
        query = f""" INSERT INTO public.paciente(nome, endereco, cep, rg, cpf, telefone, email, data_nascimento, responsavel, medico_solicitante, crm, ocupacao, cid, observacao, pagamento, empresa, numero_carteirinha, plano) 
        VALUES ('{nome}', '{endereco}', '{cep}', '{rg}', '{cpf}', '{telefone}', '{email}', '{data_nascimento}', '{responsavel}', '{medico_solicitante}', '{crm}', '{ocupacao}', '{cid}', '{observacao}', '{pagamento}', '{empresa}', '{numero_carteirinha}', '{plano}');"""
